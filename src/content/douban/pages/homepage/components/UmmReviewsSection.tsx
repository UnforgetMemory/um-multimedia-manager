...
interface UmmReviewsSectionProps {
  records: Map<string, StoreRecord>
}

/**
 * UmmReviewsSection — side-effect component that enhances native Douban
 * #reviews .review items with UMM status badges.
 *
 * Operates on the existing DOM rather than rendering its own elements.
 * Ported from the Vue UmmReviewsSection component.
 */
export const UmmReviewsSection: React.FC<UmmReviewsSectionProps> = ({ records }) => {
  ...
  // Side-effect component: no visible output
  return null
}
