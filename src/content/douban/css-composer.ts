...
const PAGE_CSS_PRESETS: Record<PageType['type'], { shared: string[]; page: string[] }> = {
  ...
  'book-profile':     { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base', 'empty-state'], page: ['book-profile'] },
  ...
  'user-reviews':     { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base', 'userbar', 'titlebar', 'empty-state'], page: ['user-reviews'] },
  'book-reviews':     { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base', 'userbar', 'titlebar', 'empty-state'], page: ['book-reviews'] },
