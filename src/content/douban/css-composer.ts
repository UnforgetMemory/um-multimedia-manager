...
const PAGE_CSS_PRESETS: Record<PageType['type'], { shared: string[]; page: string[] }> = {
  ...
  'doulists':         { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base'], page: ['doulists'] },
  'doulist-detail':   { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base'], page: ['doulist-detail'] },
  'user-media':       { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base'], page: ['user-media'] },
  'user-celebrities': { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base'], page: ['user-celebrities'] },
  'user-reviews':     { shared: ['design-tokens', 'theme', 'breakpoints', 'page-layout', 'base'], page: ['user-reviews'] },
