 ...
 *
 * Props:
 *   - aspectRatio: sets container aspect-ratio (e.g. "2/3", "16/9")
 *   - eager: force loading="eager" instead of lazy
 *   - href: wrap content in an <a target="_blank"> when set
 *   - class: applied to the <img> element (default: "umm-image-img")
 */
